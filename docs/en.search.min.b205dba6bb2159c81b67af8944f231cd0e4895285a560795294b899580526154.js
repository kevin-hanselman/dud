...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/dud/flexsearch.min.js');loadScript('/dud/en.search-data.min.5cfda661b55201a703d69fc29f12ab71766e955e6592e63e1d770c3456cb16dc.js',function(){input.required=false;search();});}
