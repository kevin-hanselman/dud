...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/dud/flexsearch.min.js');loadScript('/dud/en.search-data.min.37255408a12f5b7934cb4ba8ef0a7ea77c1cf483c4f8aeb16eda46997224d8fc.js',function(){input.required=false;search();});}
